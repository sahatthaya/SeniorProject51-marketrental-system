    ...
    <div class="sidebar close">
        ...
        <ul class="nav-links">
            ...
            <li class="navlink">
                ...
                <a href="../users-merchant/rent.php">
                ...
                <ul class="sub-menu blank">
                    ...
                    <li><a class="link_name" href="../users-merchant/rent.php">จัดการการจอง</a></li>
            ...
            <li class="navlink">
                ...
                <a href="../users-merchant/payment.php">
                ...
                <ul class="sub-menu blank">
                    ...
                    <li><a class="link_name" href="../users-merchant/payment.php">ชำระค่าเช่า</a></li>

                </ul>

            </li>
            <li class="navlink">
                <a href="../users-merchant/comp-status.php">
                ...
                <ul class="sub-menu blank">
                    ...
                    <li><a class="link_name" href="../users-merchant/comp-status.php">ติดตามคำร้องเรียน</a></li>
