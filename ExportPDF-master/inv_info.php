...
<body>
    <nav aria-label="breadcrumb mb-3">
        <ol class="breadcrumb ">
            <li class="breadcrumb-item fs-5 "><a href="../users-merchant/payment.php?mkr_id=<?php echo $mkr_id ?>" class="text-decoration-none">ชำระค่าเช่าแผง</a></li>
        ...
        <div id="table" class="bannertb border p-3 shadow-sm rounded mt-2">
            ...
            <table class="display table table-striped table-hover " style="width: 100%;">
                ...
                <tbody>
                    ...
                    @$totalcal = $total * 100;
                    $price = $row["INV_rentprice"] - $row["INV_discount"] + $cost;
                    ?>
            ...
            if ($row['INV_status'] == '1') { ?>
                <hr class="mb-0">
                <div class="text-end">
                    <form id="checkoutForm" method="POST" action="../backend/checkout-payrent.php" enctype="multipart/form-data" class="was-validated">
                        ...
                        <input type="submit" id="checkoutButton" class="btn w-25 mt-3" style="background-color: #000374;color:white;" value="ชำระเงิน" />
                    </form>
                </div>
            <?php
            } else {
