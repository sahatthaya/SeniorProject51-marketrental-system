...
<body>
    ...
    <div class="d-flex justify-content-end gap-2 bar">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuClickableInside">
            ...
            <li><a class="dropdown-item" href="../users-merchant/edit-profile.php"><i class='bx bxs-user-detail'></i>แก้ไขโปรไฟล์</a></li>

            <li><a class="dropdown-item" href="../users-merchant/password.php"><i class='bx bx-key'></i>เปลี่ยนรหัสผ่าน</a></li>
