        ...
        <div class="container-fluid">
            ...
            <div class="d-flex">
                <div class="dropdown dd-show">
                    <button class="btn dropdown-toggle pe-1 border-0 position-relative" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <hr class="text-white">
                    <li class="nav-item mx-3 mt-2">
                        <a href="payment.php" class="text-decoration-none text-white">
                            <span class="link_name">ชำระค่าเช่า</span>
                        </a>
                    </li>
                    <hr class="text-white">
                    <li class="nav-item mx-3 mt-2">
                        <a href="comp-status.php" class="text-decoration-none text-white">
                            <span class="link_name">ติดตามคำร้องเรียน</span>
                        </a>
                    </li>
                    <hr class="text-white">
