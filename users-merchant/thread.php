...
<body>
                ...
                <div>
                    <div class="border rounded shadow-sm p-3 my-2 comp-card <?php echo $bg ?>">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                <?php $time = date('g:i a', strtotime($row2['timestamp']) + 60 * 60 * 7
);
    ...
    <!-- reply -->
    <div id="replydiv" style="display: <?php echo $usersid == $c['users_id'] ? 'block' : 'none'; ?>;">
        <hr>
        <div class="border rounded shadow-sm p-3">
            ...
            <form method="POST" enctype="multipart/form-data" class="was-validated">
                ...
                <div class="text-end">
                    <button name="reply" type="submit" class="btn btn-primary w-25">ส่ง <i class='bx bxs-paper-plane'></i></button>
                </div>
