...
<head>
    ...
    <title>ส่งคำร้องขอเพิ่มตลาดใหม่</title>
        ...
        <form id="applyform" method="POST" enctype="multipart/form-data" novalidate>
            ...
            <div class="form-outer form-group" style="overflow: visible;">
                ...
                <div id="stepOne" class="row">
                    ...
                    <input class="form-control col-6" type="text" placeholder="ชื่อ" name="firstName" pattern="[^0-9]+" value="<?php echo $row['firstName']; ?>" required autofocus>
                    <div class="des_input">นามสกุล</div>
                    <input class="form-control col-6" type="text" placeholder="นามสกุล" name="lastName" pattern="[^0-9]+" value="<?php echo $row['lastName']; ?>" required>
